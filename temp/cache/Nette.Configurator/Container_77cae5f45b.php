<?php
// source: C:\Users\Lenovo\Documents\GitHub\simple editor system\app/config/config.neon 
// source: C:\Users\Lenovo\Documents\GitHub\simple editor system\app/config/config.local.neon 

class Container_77cae5f45b extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\Users\Lenovo\Documents\GitHub\simple editor system\app',
			'wwwDir' => 'C:\Users\Lenovo\Documents\GitHub\simple editor system\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\Users\Lenovo\Documents\GitHub\simple editor system\app/../temp',
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\Lenovo\Documents\GitHub\simple editor system\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\Users\Lenovo\Documents\GitHub\simple editor system\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\Lenovo\Documents\GitHub\simple editor system\app/../temp/cache',
	...
	{
		return new Container_77cae5f45b_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\Users\Lenovo\Documents\GitHub\simple editor system\app/../temp/cache/latte');
...
final class Container_77cae5f45b_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_77cae5f45b $container)
	{
