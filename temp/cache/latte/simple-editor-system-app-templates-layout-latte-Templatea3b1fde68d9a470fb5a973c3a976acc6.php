<?php
// source: C:\Users\Lenovo\Documents\GitHub\simple editor system\app/templates/@layout.latte

class Templatea3b1fde68d9a470fb5a973c3a976acc6 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('bb3560e68e', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block css
//
if (!function_exists($_b->blocks['css'][] = '_lb877b0f3591_css')) { function _lb877b0f3591_css($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb67c78b5b51_scripts')) { function _lb67c78b5b51_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
